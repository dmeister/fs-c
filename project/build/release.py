...
release_tar.add("src/main/other/hazelcast.xml", "/conf/hazelcast.xml")
release_tar.add("src/main/other/hosts", "/conf/hosts")
...
release_tar.add("lib_managed/scala_2.9.0/compile/grizzled-scala_2.9.0-1.0.6.jar", "lib/grizzled-1.0.6.jar")
